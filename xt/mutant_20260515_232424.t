...
# --- SURVIVOR: COND_INV_400_2 (MEDIUM) line 400 in new() ---
# Source:  Must be a non-negative integer.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_400_2 line 400 in new()';
    # NOTE: new is a class method — call directly.
    my $result = Genealogy::Relationship::Name->new(...);
    # ok($result, 'COND_INV_400_2: add assertion here');
    # TODO: exercise line 400 in new() to detect the mutant
    fail('COND_INV_400_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_401_3 (MEDIUM) line 401 in new() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_401_3 line 401 in new()';
    # NOTE: new is a class method — call directly.
    my $result = Genealogy::Relationship::Name->new(...);
    # ok($result, 'COND_INV_401_3: add assertion here');
    # TODO: exercise line 401 in new() to detect the mutant
    fail('COND_INV_401_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_413_4 (MEDIUM) line 413 in new() ---
# Source:  An optional person object (e.g. a C<Gedcom::Individual> instance) passed
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_413_4 line 413 in new()';
    # NOTE: new is a class method — call directly.
    my $result = Genealogy::Relationship::Name->new(...);
    # ok($result, 'BOOL_NEGATE_413_4: add assertion here');
    # TODO: exercise line 413 in new() to detect the mutant
    fail('BOOL_NEGATE_413_4: replace with real assertion');
}

# --- SURVIVOR: COND_INV_418_2 (MEDIUM) line 418 in new() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_418_2 line 418 in new()';
    # NOTE: new is a class method — call directly.
    my $result = Genealogy::Relationship::Name->new(...);
    # ok($result, 'COND_INV_418_2: add assertion here');
    # TODO: exercise line 418 in new() to detect the mutant
    fail('COND_INV_418_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_420_3 (MEDIUM) line 420 in new() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_420_3 line 420 in new()';
    # NOTE: new is a class method — call directly.
    my $result = Genealogy::Relationship::Name->new(...);
    # ok($result, 'BOOL_NEGATE_420_3: add assertion here');
    # TODO: exercise line 420 in new() to detect the mutant
...
# Source:  supported_languages ______________________________________
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- SURVIVOR: BOOL_NEGATE_582_2 (MEDIUM) line 582 in supported_languages() ---
# Source:  =head3 ARGUMENTS
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_582_2 line 582 in supported_languages()';
    # NOTE: new() called with no arguments as a starting point.
    # If Genealogy::Relationship::Name requires constructor arguments, add them here.
    my $obj = new_ok('Genealogy::Relationship::Name');
    # TODO: exercise line 582 in supported_languages() to detect the mutant
    fail('BOOL_NEGATE_582_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_637_2 (MEDIUM) line 637 in known_sexes() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_637_2 line 637 in known_sexes()';
    # NOTE: new() called with no arguments as a starting point.
    # If Genealogy::Relationship::Name requires constructor arguments, add them here.
    my $obj = new_ok('Genealogy::Relationship::Name');
    # TODO: exercise line 637 in known_sexes() to detect the mutant
...
# --- LOW HINT: RETURN_UNDEF_413_4 line 413 in new() ---
# Source:  An optional person object (e.g. a C<Gedcom::Individual> instance) passed
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new is a class method — call directly.
# e.g. my $result = Genealogy::Relationship::Name->new(...);
# ok($result, 'RETURN_UNDEF_413_4: add assertion here');

# --- LOW HINT: RETURN_UNDEF_420_3 line 420 in new() ---
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new is a class method — call directly.
# e.g. my $result = Genealogy::Relationship::Name->new(...);
# ok($result, 'RETURN_UNDEF_420_3: add assertion here');
...
# --- LOW HINT: RETURN_UNDEF_582_2 line 582 in supported_languages() ---
# Source:  =head3 ARGUMENTS
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_637_2 line 637 in known_sexes() ---
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new() called with no arguments as a starting point.
